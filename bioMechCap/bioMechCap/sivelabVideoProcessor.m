...
@interface sivelabVideoProcessor ()
...
@implementation sivelabVideoProcessor
...
{
	/*
		Overview: sivelab uses separate GCD queues for audio and video capture.  If a single GCD queue
		is used to deliver both audio and video buffers, and our video processing consistently takes
		too long, the delivery queue can back up, resulting in audio being dropped.
		
		When recording, sivelab creates a third GCD queue for calls to AVAssetWriter.  This ensures
		that AVAssetWriter is not called to start or finish writing from multiple threads simultaneously.
		
		sivelab uses AVCaptureSession's default preset, AVCaptureSessionPresetHigh.
	 */
...
//	[videoIn release];
	...
	/*
		sivelab prefers to discard late video frames early in the capture pipeline, since its
