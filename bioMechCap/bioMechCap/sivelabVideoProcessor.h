...
@protocol sivelabVideoProcessorDelegate;

// this adopts the AVCaptureAudio and Video DataOutput delegates 
@interface sivelabVideoProcessor : NSObject <AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureVideoDataOutputSampleBufferDelegate> 
{  
//    id <sivelabVideoProcessorDelegate> delegate;
...
@property (readwrite, assign) id <sivelabVideoProcessorDelegate> delegate;
...
@protocol sivelabVideoProcessorDelegate <NSObject>
@required
